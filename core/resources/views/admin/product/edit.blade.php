...
@extends('admin.master') @section('title') Updatae Product  @endsection @section('css')
...
<div class="page-content-wrapper">
    <div class="page-content">
        <h3 class="page-title uppercase bold">Updatae Product
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <i class="fa fa-plus"></i>Updatae Product
                    </div>
                        ...
                        <form action="{{route('admin.product.update')}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <img src="{{asset($product->image)}}" class="img-thumbnail" style="height: 120px;">
                                </div>
                            </div>
