...
Route::get('/product/{id}','WelcomeController@product')->name('product');
...
Route::group(['prefix'=>'admin','middleware'=>['auth']],function(){
   ...
   Route::post('app-delete','AppController@delete')->name('admin.app.delete');
    ...
    Route::get('products','ProductsController@index')->name('admin.product');
    ...
    Route::get('product-edit/{id}','ProductsController@edit')->name('admin.product.edit');
    Route::post('product-update','ProductsController@update')->name('admin.product.update');
    Route::post('product-delete','ProductsController@delete')->name('admin.product.delete');
